    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          /* reload(true) */
          ;
          (0, _alert.showAlert)('success', 'Log out successful');
          _context2.next = 11;
          break;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5qYW5wb29uYWNoYSIsImEiOiJjazQ5dWR3MGgwN2FrM21teHB4bnFuYnVkIn0.C6QTqo19RJcxnDCn0e5J0A';
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          return _context.abrupt("return", (0, _alert.showAlert)('success', "Successfully updated the ".concat(type)));

        case 7:
          (0, _alert.showAlert)('error', 'Error while updating, Try again later!');
          _context.next = 13;
          break;
